...
var Game = {
	...
	init : function(){
		...
		//设置触屏移动事件
		document.body.ontouchmove  = function(e){;_this.ontouchmove (e);}
		document.body.ontouchup  = function(e){;_this.ontouchup (e);}
	},
	//启动飞机
	startFlyer : function(){
		var _this = this;
	...
	move : function(){
		var div1=document.getElementById('flyer');
		var body=document.getElementById('gamePanel');

		//控制飞机运行最大范围
		var maxW=body.clientWidth-div1.offsetWidth;
		var maxH=body.clientHeight-div1.offsetHeight;
	...
	ontouchmove : function(e){
		e = e || window.event;
		this.flyer.touchmove(e);
	},
	//离开屏幕事件
	ontouchup : function(e){
		e = e || window.event;
		this.flyer.touchend(e);
	},
	//键盘按下事件
